...
export function useSourceManagementController(params: UseSourceManagementControllerParams): SourceManagementPanelController {
  return {
    ...
    sourceManageQuickView: params.sourceManagementState.sourceManageQuickView,
    onSetSourceManageQuickView: params.sourceManagementState.setSourceManageQuickView,
    sourceManageSortKey: params.sourceManagementState.sourceManageSortKey,
    onSetSourceManageSortKey: params.sourceManagementState.setSourceManageSortKey,
    sourceManageSortDesc: params.sourceManagementState.sourceManageSortDesc,
    onSetSourceManageSortDesc: params.sourceManagementState.setSourceManageSortDesc,
    ...
    bulkPollSec: params.sourceManagementState.bulkPollSec,
    onSetBulkPollSec: params.sourceManagementState.setBulkPollSec,
    ...
    onRunBulkPollIntervalUpdate: params.sourceManagementActions.onRunBulkPollIntervalUpdate,
    onRunBulkAIBriefingAction: params.sourceManagementActions.onRunBulkAIBriefingAction,
    ...
    exportingSources: params.sourceManagementState.exportingSources,
    importingSources: params.sourceManagementState.importingSources,
    onExportSources: params.sourceManagementActions.onExportSources,
    onImportSourcesFile: params.sourceManagementActions.onImportSourcesFile,
