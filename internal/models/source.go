...
type Source struct {
	...
	AIBriefingEnabled         bool        `json:"ai_briefing_enabled" gorm:"column:ai_briefing_enabled;not null;default:false"`
	AIBriefingIntervalMin     int         `json:"ai_briefing_interval_min" gorm:"column:ai_briefing_interval_min;not null;default:360"`
	AIBriefingLastRunAt       *time.Time  `json:"ai_briefing_last_run_at,omitempty" gorm:"column:ai_briefing_last_run_at"`
	AIBriefingLastGeneratedAt *time.Time  `json:"ai_briefing_last_generated_at,omitempty" gorm:"column:ai_briefing_last_generated_at"`
